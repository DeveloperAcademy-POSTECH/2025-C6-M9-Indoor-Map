...
extension AppTeamMember {
    static let tntMembers: [AppTeamMember] = [
        AppTeamMember(id: "Go", name: "고재현 (GO)", position: "Product Owner", description: "치열하게 설계하고 집요하게 검증하며 앞으로만 갑니다.", linkedInURL: URL(string: "https://www.linkedin.com/in/jaehyun-go-91a072356/")!),
